...
personality_weights             theta alpha                     (θα),           "personality weights", correlation between the personality traits of the OCEAN model 
...
ACTION_CATALOG: List[RegulationAction] = [
    ...
    RegulationAction(
        ...
        personality_weights={"openness": 0.0, "conscientiousness": 1.0, "extraversion": 1.0, "agreeableness": -1.0, "neuroticism": 0.0}
    ),
    RegulationAction(
        name="Distraction",
        strategy_family="Attentional Deployment",
        delta_Sa=(-0.3, 0.2), # Example from Table 2
        personality_weights={"openness": 1.0, "conscientiousness": 1.0, "extraversion": 1.0, "agreeableness": 0.0, "neuroticism": 0.0}
    ),
    RegulationAction(
        name="Reappraisal",
        strategy_family="Cognitive Change",
        delta_Sa=(-0.1, 0.3), # Example from Table 2
        personality_weights={"openness": 1.0, "conscientiousness": 0.0, "extraversion": 0.0, "agreeableness": 1.0, "neuroticism": 0.0}
    ),
    ...
    RegulationAction(
        ...
        personality_weights={"openness": 0.0, "conscientiousness": 0.0, "extraversion": 0.0, "agreeableness": 0.0, "neuroticism": 1.0}
    ),
]